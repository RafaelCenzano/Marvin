...
def marvin(data):
  ...
  if "Google image search" or "image search" in data:
    data = data.split(" ")
    image_search = data[2]
  ...
  if "Google search" or "search" in data:
    data = data.split(" ")
  ...
  if "sleep Marvin" or "bye Marvin" in data:
    speak("Ok, Bye sir")
    exit()
  ...
  if "calculator mode" in data:
    ...
    for t in range(0, g ):
      ...
      if choice == '1':
        ...
        num1 = int(raw_input("Enter the number you want to squareroot: "))
